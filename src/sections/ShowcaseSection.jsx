...
const ShowcaseSection = () => {
    ...
    useGSAP(() => {
        ...
        const projects = [projec1tRef.current, project2Ref.current, project3Ref.current];
                ...
                <div className="first-project-wrapper " ref={projec1tRef}>
                    ...
                    <div className="text-content">
                        ...
                        <p className="text-white-50 md:text-xl">
                            An app built with React Native, Expo, & Tailwingcss for a fast, user-friendly experience.
                        </p>
                    </div>
                </div>
